...
"Waste Sensor" [device profile](/docs/{{docsPrefix}}user-guide/device-profiles/).
The user may set the values for triggering alarms on the "Waste Management Administration" dashboard via the "Alarm rules" form.
